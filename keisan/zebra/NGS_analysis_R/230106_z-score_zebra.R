...
gene_heatmap(fData, pData, tpm, gene, save, exact=F, Colv=F,cexRow=0.5)
...
gene <- c("^otx1", "^otx2a", "^otx2b", "^egr2a", "^egr2b", "^meis1a", "^meis1b", "^meis2a", "^meis2b","^fgf8a", "^fgf8b")
save <- "HOX related genes"
gene_heatmap(fData, pData, tpm, gene, save, exact=F, Colv=F)
save <- paste(save, "_No_cluster", sep="")
...
gene_heatmap(fData, pData, tpm, gene, save, exact=T, Colv=F)
save <- paste(save, "_No_cluster", sep="")
